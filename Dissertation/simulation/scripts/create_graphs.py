...
class ReadLogs:
    def __init__(self) -> None:
        ...
        plt.plot(x_axis,ST_WB_0[0],'ro-',x_axis,ST_NB_0[0],'go-',x_axis,ST_WB_0[1],'bs--',x_axis,ST_NB_0[1],'ms--')
        plt.xticks(range(0,10))
        plt.yticks(range(50,200,10))
        plt.title("PIONEER X HUSKY" + " | SIMULATION TIME | A -> B")
        plt.xlabel("INDICE")
        plt.ylabel("TEMPO [s]")
        plt.legend(['SIMULATION TIME HUSKY WITH BLOCK','SIMULATION TIME HUSKY NO BLOCK','SIMULATION TIME PIONEER WITH BLOCK','SIMULATION TIME PIONEER NO BLOCK'])
        # plt.savefig('sXr_wb_ab_pt1.png',dpi=720)
        plt.show()

        plt.plot(x_axis,RT_WB_0[0],'ro-',x_axis,RT_NB_0[0],'go-',x_axis,RT_WB_0[1],'bs--',x_axis,RT_NB_0[1],'ms--')
        plt.xticks(range(0,10))
        plt.yticks(range(50,210,10))
        plt.title("PIONEER X HUSKY" + " | REAL TIME | A -> B")
        plt.xlabel("INDICE")
        plt.ylabel("TEMPO [s]")
        plt.legend(['REAL TIME HUSKY WITH BLOCK','REAL TIME HUSKY NO BLOCK','REAL TIME PIONEER WITH BLOCK','REAL TIME PIONEER NO BLOCK'])
        # plt.savefig('sXr_wb_ab_pt1.png',dpi=720)
        plt.show()

        plt.plot(x_axis,ST_WB_1[0],'ro-',x_axis,ST_NB_1[0],'go-',x_axis,ST_WB_1[1],'bs--',x_axis,ST_NB_1[1],'ms--')
        plt.xticks(range(0,10))
        plt.yticks(range(50,200,10))
        plt.title("PIONEER X HUSKY" + " | SIMULATION TIME | B -> A")
        plt.xlabel("INDICE")
        plt.ylabel("TEMPO [s]")
        plt.legend(['SIMULATION TIME HUSKY WITH BLOCK','SIMULATION TIME HUSKY NO BLOCK','SIMULATION TIME PIONEER WITH BLOCK','SIMULATION TIME PIONEER NO BLOCK'])
        # plt.savefig('sXr_wb_ab_pt1.png',dpi=720)
        ...
        plt.plot(x_axis,RT_WB_1[0],'ro-',x_axis,RT_NB_1[0],'go-',x_axis,RT_WB_1[1],'bs--',x_axis,RT_NB_1[1],'ms--')
        plt.xticks(range(0,10))
        plt.yticks(range(50,200,10))
        plt.title("PIONEER X HUSKY" + " | REAL TIME | B -> A")
        plt.xlabel("INDICE")
        plt.ylabel("TEMPO [s]")
        plt.legend(['REAL TIME HUSKY WITH BLOCK','REAL TIME HUSKY NO BLOCK','REAL TIME PIONEER WITH BLOCK','REAL TIME PIONEER NO BLOCK'])
        # plt.savefig('sXr_wb_ab_pt1.png',dpi=720)
